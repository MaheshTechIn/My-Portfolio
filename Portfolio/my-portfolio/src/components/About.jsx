    ...
    return (
        <section className="about">
            ...
            <ul className="about-list">
                <li><strong>Education:</strong> Bachelor of Technology (B.Tech)</li>
                <li><strong>Programming:</strong> Java, HTML, CSS, JavaScript</li>
                <li><strong>Frameworks:</strong> React, Spring Boot</li>
                <li><strong>Tools:</strong> Git, VS Code, Eclipse, Ubuntu</li>
